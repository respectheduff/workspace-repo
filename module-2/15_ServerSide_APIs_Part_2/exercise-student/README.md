...
Before you begin, open the starter code in IntelliJ. Then, review the starting code. It should look familiar to you as it picks up where you left off in the previous tutorial.
