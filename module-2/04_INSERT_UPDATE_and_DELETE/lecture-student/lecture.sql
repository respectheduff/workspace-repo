...
INSERT INTO city 
VALUES (DEFAULT, 'Hawkins', 30000, 14.710);
...
UPDATE state
SET capitol = (SELECT city_id FROM city WHERE city_name = 'Anaheim' AND state_abbreviation = 'CA')
WHERE state_abbreviation = 'CA'
...
DELETE FROM city 
WHERE city_id = (SELECT city_id FROM city WHERE city_name = 'Hawkins');
...
INSERT INTO city
VALUES(DEFAULT, 'Gotham', 'xx'. 330000000. 1000);
...
UPDATE state
SET state_nickname = 'Vacation Land'
WHERE state_abbreviation = 'CA';
...
-- TRANSACTIONS
-- Start transaction
--  do some stuff (Inserts, Deletes, Updates)
-- ....
-- COMMIT/ROLLBACK
